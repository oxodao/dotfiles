...
require('nvim-treesitter.configs').setup {
  ...
  ensure_installed = { 'c', 'cpp', 'go', 'lua', 'python', 'rust', 'typescript', 'help', 'vim', 'go', 'html', 'javascript', 'json', 'python', 'sql', 'tsx', 'yaml' },
...
local on_attach = function(_, bufnr)
  ...
  -- nmap('<a-cr>', require('telescope.builtin').lsp_code_actions(require('telescope.themes').get_cursor()), '[C]ode [A]ction')
